...
//                 </a>
//			 </li>
          foreach ($images as $smallbox){
              echo " <li>".
                 "<a href=\"detail.php?id=".$smallbox["id"]."\" class=\"img-responsive\">".
                 	"<img src=\"images/square/".$smallbox["path"]."\" alt=\"View of Cologne\">".
                 	"<div class=\"caption\"><div class=\"blur\"></div><div class=\"caption-text\"><h1>".$smallbox["title"]."</h1></div></div></a></li>";
          }
          ?>
